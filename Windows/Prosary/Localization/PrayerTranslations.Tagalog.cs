...
public static partial class PrayerTranslations
{
    private static readonly Dictionary<string, string> Tagalog = new()
    {
        ...
        [PrayerKey.VersiculumPaschale] = "Magalak at matuwa, O Birheng Maria, aleluya.",
        [PrayerKey.ResponsiumPaschale] = "Sapagkat si Jesus ay tunay na nabuhay na mag-uli, aleluya.",
        ...
        [PrayerKey.AveMariaProFide] = "Aba Ginoong Maria — para sa pagdami ng Pananampalataya.",
