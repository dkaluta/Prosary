...
// approach used for other languages. Titles/fruits are standard Catholic Rosary terminology in
// Tagalog — recommend a native-speaker / diocesan review of those before pastoral use.
public static partial class MysteryTranslations
{
    private static readonly Dictionary<string, MysteryText> Tagalog = new()
    {
        // Joyful
        ["joyful_01_annunciation"] = new(
            "Ang Pagpapahayag", "Kababaang-loob",
        ...
        ["sorrowful_01_agony_in_the_garden"] = new(
            "Ang Paghihirap sa Halamanan", "Pagsisisi sa Kasalanan",
        ...
        ["sorrowful_03_crowning_with_thorns"] = new(
            "Ang Pagkokorona ng Tinik", "Tapang sa Moral",
        ...
        ["sorrowful_05_crucifixion"] = new(
            "Ang Pagpapako sa Krus", "Kaligtasan",
        ...
        ["glorious_01_resurrection"] = new(
            "Ang Muling Pagkabuhay", "Pananampalataya",
        ...
        ["glorious_05_coronation"] = new(
            "Ang Pagkokorona kay Maria", "Tiwala sa Pamamagitan ni Maria",
            "At lumitaw ang isang dakilang tanda sa langit: isang babae na may damit na araw, at " +
            "ang buwan ay nasa ilalim ng kaniyang mga paa, at sa kaniyang ulo ay may putong na " +
            "labindalawang bituin.\n\n— Pahayag 12:1 (Ang Dating Biblia)"),
        ...
        ["luminous_01_baptism"] = new(
            "Ang Bautismo sa Jordan", "Pagiging Bukas sa Espiritu Santo",
