//
//  PrayerTranslations+English.swift
//  Prosary
//
...
extension PrayerTranslations {
  static let english: [PrayerKey: String] = [
    ...
    .versiculumStandard: "Pray for us, O holy Mother of God.",
    .responsiumStandard: "That we may be made worthy of the promises of Christ.",
    .collectaStandard:
    ...
    .versiculumPaschale: "Rejoice and be glad, O Virgin Mary, alleluia.",
    .responsiumPaschale: "For the Lord has truly risen, alleluia.",
    .collectaPaschale:
