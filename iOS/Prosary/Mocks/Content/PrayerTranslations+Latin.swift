//
//  PrayerTranslations+Latin.swift
//  Prosary
//
...
extension PrayerTranslations {
  static let latin: [PrayerKey: String] = [
    .signumCrucis:
    ...
    .versiculumStandard: "Ora pro nobis, sancta Dei Genetrix.",
    .responsiumStandard: "Ut digni efficiamur promissionibus Christi.",
    .collectaStandard:
    ...
    .versiculumPaschale: "Gaude et laetare, Virgo Maria, alleluia.",
    .responsiumPaschale: "Quia surrexit Dominus vere, alleluia.",
    .collectaPaschale:
    ...
    .aveMariaProFide: "Ave Maria — ad augendam fidem.",
