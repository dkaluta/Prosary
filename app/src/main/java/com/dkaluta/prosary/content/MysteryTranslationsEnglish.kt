...
val mysteryTranslationsEnglish: Map<String, MysteryText> = mapOf(
    // Joyful
    "joyful_01_annunciation" to MysteryText(
        title = "The Annunciation", fruit = "Humility",
        description =
    ...
    "joyful_02_visitation" to MysteryText(
        title = "The Visitation", fruit = "Love of Neighbor",
        description =
    ...
    "joyful_03_nativity" to MysteryText(
        title = "The Nativity", fruit = "Poverty of Spirit",
        description =
    ...
    "joyful_04_presentation" to MysteryText(
        title = "The Presentation", fruit = "Obedience",
        description =
    ...
    "joyful_05_finding_in_the_temple" to MysteryText(
        title = "The Finding in the Temple", fruit = "Piety",
        description =
    ...
    "sorrowful_01_agony_in_the_garden" to MysteryText(
        title = "The Agony in the Garden", fruit = "Sorrow for Sin",
        description =
    ...
    "sorrowful_02_scourging_at_the_pillar" to MysteryText(
        title = "The Scourging at the Pillar", fruit = "Purity",
        description =
            "Then therefore, Pilate took Jesus, and scourged him.\n\n— John 19:1 (Douay-Rheims)"),
    "sorrowful_03_crowning_with_thorns" to MysteryText(
        title = "The Crowning with Thorns", fruit = "Moral Courage",
        description =
    ...
    "sorrowful_04_carrying_of_the_cross" to MysteryText(
        title = "The Carrying of the Cross", fruit = "Patience",
        description =
    ...
    "sorrowful_05_crucifixion" to MysteryText(
        title = "The Crucifixion", fruit = "Salvation",
        description =
    ...
    "glorious_01_resurrection" to MysteryText(
        title = "The Resurrection", fruit = "Faith",
        description =
    ...
    "glorious_02_ascension" to MysteryText(
        title = "The Ascension", fruit = "Hope",
        description =
    ...
    "glorious_03_descent_of_the_holy_spirit" to MysteryText(
        title = "The Descent of the Holy Spirit", fruit = "Wisdom and Love of God",
        description =
    ...
    "glorious_04_assumption" to MysteryText(
        title = "The Assumption of Mary", fruit = "Grace of a Happy Death",
        description =
    ...
    "glorious_05_coronation" to MysteryText(
        title = "The Coronation of Mary", fruit = "Trust in Mary's Intercession",
        description =
            "And a great sign appeared in heaven: A woman clothed with the sun, and the moon under her " +
                "feet, and on her head a crown of twelve stars.\n\n— Apocalypse 12:1 (Douay-Rheims)"),
    ...
    "luminous_01_baptism" to MysteryText(
        title = "The Baptism in the Jordan", fruit = "Openness to the Holy Spirit",
        description =
    ...
    "luminous_02_wedding_at_cana" to MysteryText(
        title = "The Wedding at Cana", fruit = "To Jesus through Mary",
        description =
    ...
    "luminous_03_proclamation_of_the_kingdom" to MysteryText(
        title = "The Proclamation of the Kingdom", fruit = "Repentance and Trust in God",
        description =
    ...
    "luminous_04_transfiguration" to MysteryText(
        title = "The Transfiguration", fruit = "Desire for Holiness",
        description =
    ...
    "luminous_05_institution_of_the_eucharist" to MysteryText(
        title = "The Institution of the Eucharist", fruit = "Adoration and Love of the Eucharist",
        description =
    ...
    // SevenSorrowsCatalog.kt. All seven are new content; only the Crucifixion overlaps a Rosary
    // Sorrowful Mystery thematically, not in citation (this one is Mary's own vantage at the foot
    // of the Cross, John 19, not the moment of Jesus's death, Luke 23, used for
