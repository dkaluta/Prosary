...
class DivineMercyEngineTest {
    ...
    fun fiveDecadesOfTenPetitions() {
        val steps = engine.buildSteps(Prayer(kind = PrayerKind.DivineMercyChaplet, languageCode = "en"))
    ...
    fun latinBodyContainsLatinText() {
        val steps = engine.buildSteps(Prayer(kind = PrayerKind.DivineMercyChaplet, languageCode = "la"))
