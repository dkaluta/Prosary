...
val prayerTranslationsLatin: Map<PrayerKey, String> = mapOf(
    ...
    PrayerKey.VersiculumPaschale to "Gaude et laetare, Virgo Maria, alleluia.",
    PrayerKey.ResponsiumPaschale to "Quia surrexit Dominus vere, alleluia.",
    ...
    PrayerKey.AveMariaProFide to "Ave Maria — ad augendam fidem.",
