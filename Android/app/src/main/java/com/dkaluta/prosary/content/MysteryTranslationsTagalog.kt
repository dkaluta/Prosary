...
/**
 * Descriptions are Ang Dating Biblia (1905), quoted exactly, matching the verbatim-Scripture
 * approach used for other languages.
 * Titles/fruits are standard Catholic Rosary terminology in Tagalog — recommend a native-speaker
 * / diocesan review of those before pastoral use.
 */
val mysteryTranslationsTagalog: Map<String, MysteryText> = mapOf(
    // Joyful
    "joyful_01_annunciation" to MysteryText(
        title = "Ang Pagpapahayag", fruit = "Kababaang-loob",
        description =
            "At nang ikaanim na buwan ay sinugo ng Dios ang anghel na Gabriel sa isang bayan ng " +
                "Galilea, na tinatawag na Nazaret, Sa isang birhen na esponsada sa isang lalake na ang " +
                "pangalan ay Jose, na sa angkan ni David; at ang pangalan ng birhen ay Maria. At pumasok " +
                "siya sa kinaroroonan niya at nagsabi, Magalak ka, ikaw na kinaroonan ng biyaya, ang " +
                "Panginoon ay sumasaiyo. Ngunit siya'y nagtaka sa salitang ito, at nagnilay-nilay kung " +
                "anong bati ito. At sinabi sa kaniya ng anghel, Huwag kang matakot, Maria: sapagka't " +
                "natagpuan mo ang biyaya sa Dios. At narito, manganganak ka ng isang lalake, at " +
                "tatawagin mong Hesus ang kanyang pangalan. Siya'y magiging dakila, at tatawaging Anak " +
                "ng Kataastaasan: at ibibigay sa kaniya ng Panginoong Dios ang luklukan ni David na " +
                "kaniyang ama: At siya'y maghahari sa angkan ni Jacob magpakailanman; at ang kaniyang " +
                "kaharian ay walang wakas. At sinabi ni Maria sa anghel, Papaanong mangyayari ito, " +
                "yamang hindi ko nakikilala ang lalake? At sumagot ang anghel at sinabi sa kaniya, " +
                "Bababa sa iyo ang Espiritu Santo, at lililiman ka ng kapangyarihan ng Kataastaasan: " +
                "kaya naman ang banal na bagay na ipanganganak ay tatawaging Anak ng Dios. At narito, " +
                "si Elisabet na iyong kamaganak ay naglihi rin ng isang anak na lalake sa kaniyang " +
    ...
    "joyful_02_visitation" to MysteryText(
        ...
        description =
            "At nang mga araw na yaon ay bumangon si Maria at nagmadaling pumunta sa kabundukan, sa " +
                "isang bayan ng Juda; At pumasok siya sa bahay ni Zacharias at binati si Elisabet. At " +
                "nangyari, nang marinig ni Elisabet ang bating kay Maria, ay lumukso ang sanggol sa " +
                "kaniyang tiyan; at napuspos ng Espiritu Santo si Elisabet; At sumigaw siya ng malakas, " +
                "at nagsabi, Pinagpala ka sa mga babae, at pinagpala ang bunga ng iyong tiyan. At " +
    ...
    "joyful_05_finding_in_the_temple" to MysteryText(
        ...
        description =
            "At nangyari, pagkaraan ng tatlong araw ay nasumpungan nila siya sa templo, na " +
                "nakaupo sa gitna ng mga guro, na nakikinig sa kanila at nagtatanong sa kanila. At ang " +
                "lahat ng nakarinig sa kaniya ay nangagtaka sa kaniyang pang-unawa at sa kaniyang mga " +
                "sagot. At nang sila'y makakita sa kaniya, ay nangamanghang lubos: at sinabi ng " +
    ...
    "sorrowful_01_agony_in_the_garden" to MysteryText(
        title = "Ang Paghihirap sa Halamanan", fruit = "Pagsisisi sa Kasalanan",
        description =
            "At humiwalay siya sa kanila ng may isang mabatong ihagis, at lumuluhod, ay nanalangin, " +
                "Na nagsasabi, Ama, kung ibig mo, alisin mo sa akin itong inumin: gayon man huwag " +
    ...
    "sorrowful_02_scourging_at_the_pillar" to MysteryText(
        ...
        description =
            "Nang magkagayo'y kinuha ni Pilato si Jesus at pinahagupit.\n\n" +
                "— Juan 19:1 (Ang Dating Biblia)"),
    "sorrowful_03_crowning_with_thorns" to MysteryText(
        title = "Ang Pagkokorona ng Tinik", fruit = "Tapang sa Moral",
        description =
    ...
    "sorrowful_04_carrying_of_the_cross" to MysteryText(
        ...
        description =
            "At siya'y lumabas na pasan ang krus, patungo sa tinatawag na Dako ng Bungo, na " +
                "tinatawag sa Hebreo, Golgota.\n\n— Juan 19:17 (Ang Dating Biblia)"),
    "sorrowful_05_crucifixion" to MysteryText(
        title = "Ang Pagpapako sa Krus", fruit = "Kaligtasan",
        description =
            "At may mga ikaanim na oras na, at nagdilim sa buong lupain hanggang sa ikasiyam na " +
    ...
    "glorious_01_resurrection" to MysteryText(
        title = "Ang Muling Pagkabuhay", fruit = "Pananampalataya",
        description =
    ...
    "glorious_02_ascension" to MysteryText(
        ...
        description =
            "At pagkasabi niya ng mga bagay na ito, habang tinitingnan nila, siya'y inangat, at " +
                "isang ulap ang sumalubong sa kaniya at ikinubli sa kanilang paningin. At habang sila'y " +
                "nangakatintig sa langit, samantalang siya'y papaalis, narito, ay nagsipiling sa tabi " +
    ...
    "glorious_03_descent_of_the_holy_spirit" to MysteryText(
        ...
        description =
            "At biglang nagmula sa langit ang isang ugong na gaya ng sa isang humihipong " +
                "makapangyarihang hangin, at pinuno nito ang buong bahay na kinaroroonan nila. At " +
    ...
    "glorious_04_assumption" to MysteryText(
        ...
        description =
            "At lumitaw ang isang dakilang tanda sa langit: isang babae na may damit na araw, at " +
                "ang buwan ay nasa ilalim ng kaniyang mga paa, at sa kaniyang ulo ay may putong na " +
                "labindalawang bituin.\n\n— Pahayag 12:1 (Ang Dating Biblia)"),
    "glorious_05_coronation" to MysteryText(
        title = "Ang Pagkokorona kay Maria", fruit = "Tiwala sa Pamamagitan ni Maria",
        description =
            "At lumitaw ang isang dakilang tanda sa langit: isang babae na may damit na araw, at " +
                "ang buwan ay nasa ilalim ng kaniyang mga paa, at sa kaniyang ulo ay may putong na " +
                "labindalawang bituin.\n\n— Pahayag 12:1 (Ang Dating Biblia)"),
    ...
    "luminous_01_baptism" to MysteryText(
        title = "Ang Bautismo sa Jordan", fruit = "Pagiging Bukas sa Espiritu Santo",
        description =
            "At nang mabautismuhan si Jesus, pagdaka'y umahon sa tubig: at narito, nangabuksan sa " +
    ...
    "luminous_02_wedding_at_cana" to MysteryText(
        ...
        description =
            "Sinabi sa kanila ni Jesus, Punuin ninyo ng tubig ang mga palyok. At pinuno nila ang " +
                "mga iyon hanggang sa labi. At sinabi niya sa kanila, Iguhit na ninyo ngayon, at dalhin " +
                "ninyo sa puno ng handaan. At dinala nila. At nang matikman ng puno ng handaan ang tubig " +
                "na naging alak, at hindi niya nalalaman kung taga saan (datapuwa't nalalaman ng mga " +
                "alila na kumuha ng tubig), ay tinawag ng puno ng handaan ang lalaking ikakasal, At " +
                "sinabi niya sa kaniya, Ang bawa't tao ay naglalagay muna ng mabuting alak; at pagka " +
    ...
    "luminous_04_transfiguration" to MysteryText(
        ...
        description =
            "At pagkaraan ng anim na araw ay isinama ni Jesus si Pedro, at si Jacobo, at si Juan " +
                "na kaniyang kapatid, at sila'y pinahiwatig niya sa isang mataas na bundok. At siya'y " +
                "nagbagong-anyo sa harap nila; at ang kaniyang mukha ay lumiwanag na gaya ng araw, at " +
    ...
    "luminous_05_institution_of_the_eucharist" to MysteryText(
        ...
        description =
            "At samantalang sila'y nagsisikain, ay dumampot si Jesus ng tinapay, at pagkatapos na " +
                "siya'y magpasalamat, ay pinagputolputol niya, at ibinigay sa mga alagad, at sinabi, " +
