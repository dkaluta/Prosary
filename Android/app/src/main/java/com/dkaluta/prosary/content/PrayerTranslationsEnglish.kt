...
val prayerTranslationsEnglish: Map<PrayerKey, String> = mapOf(
    ...
    PrayerKey.VersiculumStandard to "Pray for us, O holy Mother of God.",
    PrayerKey.ResponsiumStandard to "That we may be made worthy of the promises of Christ.",
    ...
    PrayerKey.VersiculumPaschale to "Rejoice and be glad, O Virgin Mary, alleluia.",
    PrayerKey.ResponsiumPaschale to "For the Lord has truly risen, alleluia.",
    ...
    PrayerKey.AveMariaProFide to "Hail Mary — for an increase of Faith.",
