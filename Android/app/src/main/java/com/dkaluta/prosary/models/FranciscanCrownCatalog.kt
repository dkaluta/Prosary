 ...
 * the Magi is genuinely new content — see MysteryTranslationsEnglish.kt/MysteryTranslationsLatin.kt. */
object FranciscanCrownCatalog {
    val sevenJoys: List<String> = listOf(
