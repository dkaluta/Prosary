...
| | |
|---|---|
| [`ARCHITECTURE.markdown`](ARCHITECTURE.markdown) | The spec: the `.prosaryprayer` bundle format, the language/rite model, the engines' shared behavior. The single source of truth the three ports are verified against. |
