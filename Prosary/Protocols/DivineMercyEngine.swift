...
//  three times. Implement `StubDivineMercyEngine` (see Support/Stubs/StubDivineMercyEngine.swift)
//  with your real rules.
//

import Foundation

protocol DivineMercyEngine {
  /// Builds the full, ordered sequence of prayer steps for a Divine Mercy Chaplet session in the
  /// given language.
