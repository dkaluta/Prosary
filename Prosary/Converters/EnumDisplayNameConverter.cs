...
/// <c>FavoriteEditorPage</c> ComboBox — reuses each enum's own <c>DisplayName()</c> extension
/// (the same text Android's equivalent screens show) so the label text has one source of truth
/// instead of being duplicated here.</summary>
