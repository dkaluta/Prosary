...
public static partial class MysteryTranslations
{
    private static readonly Dictionary<string, MysteryText> English = new()
    {
        ...
        ["franciscan_04_adoration_of_the_magi"] = new(
            "The Adoration of the Magi", "Generosity",
        ...
        // SevenSorrowsCatalog.cs. All seven are new content; only the Crucifixion overlaps a
        // Rosary Sorrowful Mystery thematically, not in citation (this one is Mary's own vantage
        // at the foot of the Cross, John 19, not the moment of Jesus's death, Luke 23, used for
        // sorrowful_05_crucifixion above).
        ["seven_sorrows_01_prophecy_of_simeon"] = new(
            "The Prophecy of Simeon", "Trust in God's Will",
        ...
        ["seven_sorrows_02_flight_into_egypt"] = new(
            "The Flight into Egypt", "Fortitude in Exile",
        ...
        ["seven_sorrows_03_loss_of_jesus_in_the_temple"] = new(
            "The Loss of the Child Jesus in the Temple", "Perseverance in Seeking Christ",
        ...
        ["seven_sorrows_04_meeting_jesus_on_the_way_of_the_cross"] = new(
            "Mary Meets Jesus on the Way of the Cross", "Compassion",
        ...
        ["seven_sorrows_05_crucifixion"] = new(
            "Mary at the Foot of the Cross", "Courage in Suffering",
        ...
        ["seven_sorrows_06_descent_from_the_cross"] = new(
            "Mary Receives the Body of Jesus", "Resignation to God's Will",
        ...
        ["seven_sorrows_07_burial_of_jesus"] = new(
            "The Burial of Jesus", "Hope in the Resurrection",
