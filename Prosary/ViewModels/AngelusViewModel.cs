...
/// <summary>
/// Drives the Angelus prayer flow — no bead progress indicator (unlike
...
public partial class AngelusViewModel : ObservableObject, IPrayerStepFlowViewModel
{
    ...
    /// <summary>Id of the saved Angelus favorite matching the current language, if any — drives
    ...
    public async Task LoadAsync(Guid? prayerId)
    {
        ...
        {
            System.Diagnostics.Debug.WriteLine($"[AngelusViewModel] Failed to load Angelus session: {ex}");
            Header = "Something went wrong";
            Body = "The Angelus couldn't be loaded. Please go back and try again.";
        }
    }
