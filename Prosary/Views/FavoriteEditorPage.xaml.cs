...
public sealed partial class FavoriteEditorPage : Page
{
    ...
    private void OnReminderTimeChanged(object sender, TimePickerValueChangedEventArgs e)
    {
        ...
        {
            ViewModel.UpdateReminderTime(reminder, e.NewTime.Hours, e.NewTime.Minutes);
        }
    }
    ...
    private void OnAngelus6AmToggled(object sender, RoutedEventArgs e) => ViewModel.ToggleAngelus6AmCommand.Execute(null);

    private void OnAngelusNoonToggled(object sender, RoutedEventArgs e) => ViewModel.ToggleAngelusNoonCommand.Execute(null);

    private void OnAngelus6PmToggled(object sender, RoutedEventArgs e) => ViewModel.ToggleAngelus6PmCommand.Execute(null);
}
