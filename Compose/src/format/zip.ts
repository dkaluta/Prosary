...
// deliberately small readers (iOS MinimalZipReader): no encryption, no zip64, no data
// descriptors. The writer emits stored (uncompressed) entries — bundle payloads are JSON,
// JPEG, and Opus, the latter two already compressed — and the reader additionally inflates
// method-8 entries (bundles produced by the CLI packers) via the native DecompressionStream.
